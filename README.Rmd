...
This package is still under development. A number of functionalities are being planned or being implemented, including saving and loading networks, parallel processing, and better user interface just to name a few. 
